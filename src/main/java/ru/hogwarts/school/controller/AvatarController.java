...
public class AvatarController {
    ...
    @GetMapping("/student/{studentId}/avatar/preview")
    public ResponseEntity<byte[]> findPreview(@PathVariable Long studentId) {
    ...
    public void findAvatar(@PathVariable Long studentId, HttpServletResponse response) throws IOException {
        Avatar avatar = avatarService.findByStudentId(studentId);
